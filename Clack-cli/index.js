...
async function main() {
  ...
  p.outro(`And so ends our epic journey through the realms of coding! Whether you chose the path of the Greenhorn Initiate, the Seasoned Vanguard, or dared to tread the perilous Master Sentinel's path (sorry, hard level rejectors!), you've braved it all.
        ...
        Now, dear adventurer ${
          project.name
        }, armed with your newfound wisdom and perhaps a slightly sore butt from all that sitting, remember: the real adventure awaits beyond these pixelated realms.Go forth with courage, wit, and a good debugger!

            For any lingering bugs or existential coding crises, don't hesitate to visit our magical support portal at ${color.underline(
              color.cyan("https://example.com/issues")
            )}. Farewell, and may your code forever compile on the first try!
        `);
}
